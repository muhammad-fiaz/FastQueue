---
title: Time API
description: FastQueue time utilities API reference for monotonic clocks and high-resolution timers.
keywords: time, timer, monotonic clock, nanoseconds, performance measurement
---
