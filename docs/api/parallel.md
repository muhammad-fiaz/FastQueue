---
title: Parallel For API
description: FastQueue parallel for-loop utility API reference for distributing iterations across worker threads.
keywords: parallel for, parallel_for, parallel for-loop, multi-threaded iteration
---
